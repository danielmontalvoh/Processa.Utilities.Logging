...
| SeqServerUri | URL del servidor Seq donde se escribirán eventos de seguimiento. Ejemplo: `http://10.100.102.22:5341/`. | `null` |
| SeqApiKey | Clave en el API de Seq que identifica a la aplicación que escribe los eventos. Cada clave puede asociarse con un conjunto de propiedades que se aplicarán automáticamente a los eventos escritos con ella. La clave no es obligatoria para la escritura de los eventos. Para ver las claves: [Seq Api Keys](http://10.100.102.22:5341/#/settings/api-keys) | `null` |
